...
export const posts: BlogPost[] = [
  {
    ...
    body: [
      ...
      "At PET shop, we prioritize fit over speed. If you want a checklist tailored to your lifestyle, our team will walk you through it—no pressure, no gimmicks.",
    ],
  },
  {
    ...
    body: [
      ...
      "If you sourced your puppy through PET shop, use your go-home packet as the anchor. It is written to match the routines your puppy already knows.",
    ],
  },
  {
    ...
    body: [
      ...
      "PET shop families receive a transition feeding outline at placement so you can keep digestion steady while you build your long-term plan with your vet.",
    ],
  },
];
